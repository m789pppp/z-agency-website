...
import { ChevronLeft, ChevronRight, Sparkles, GraduationCap, School, Leaf, ArrowUpRight } from "lucide-react"
...
const successStories = [
  {
    ...
    description: "Built an AI-powered platform that helps students discover admissions opportunities, scholarships, competitions, and summer programs. The platform provides personalized educational guidance to help students achieve their academic goals.",
    outcomes: [
  ...
  {
    id: 3,
    title: "AI Hydroponic Farm",
    category: "Artificial Intelligence",
    icon: Leaf,
    impact: "Smart Agriculture Innovation",
    description: "Developed an AI-based hydroponic farm monitoring system using IoT sensors and machine learning for prediction and optimization, contributing to sustainable agriculture solutions.",
    outcomes: [
